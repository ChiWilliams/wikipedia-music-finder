...
def classifier_accuracy(classifier_result: list[TextLabel], 
    ...
    Returns:
        float from 0 to 1"""
    false_pos_percent, false_neg_percent = classifier_precision_recall(classifier_result,baseline_result)
...
def classifier_precision_recall(classifier_result: list[TextLabel],
    ...
    errors = classifier_false_positives_and_negatives(classifier_result, baseline_result)
